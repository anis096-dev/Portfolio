            ...
            <div class="modal container" style="display: inline-block;">
                <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">    
                    <div class="pr-3 pb-2">
                        ...
                        <h2 class="dark:text-white sm:text-3xl mt-2 font-medium">{{$item->title}}</h2>
                        ...
                        <div class="dark:bg-[#232220] bg-[#ffffff] flex p-4 rounded-lg">
                            ...
                            <div class="pl-5">
                                <div class="flex justify-between items-center">
                                    <h3 class="dark:text-white text-[22px] font-medium pb-1">{{$user->name}}</h3>
                                </div>
                                <p class="dark:text-white md:pr-16">{{$user->bio}}</p>
                            </div>
                        </div>
                    </div>
                </div>
