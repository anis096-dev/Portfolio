            ...
            <x-slot name="content">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    ...
                    <div class="flex flex-row items-center justify-center">
                        <div class="relative mt-4">
                            ...
                            <label>
                                ...
                                <input wire:model="iconPath" type="file" accept="image/png, image/jpeg" class="hidden opacity-0">
                            </label>
                            </span>
                    ...
                    <div class="col-span-1 col-span-4">
                        ...
                        <textarea id="desc" class="block mt-1 w-full" type="text" name="desc" wire:model.debounce.100000ms="desc"></textarea>
